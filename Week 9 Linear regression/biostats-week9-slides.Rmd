...
* To predict the level of happiness in each country based on the model, we could look at the life expectancy for each country and compute its happiness by hand using the model equation: $happiness = -1.80228 + .11446{lifeExpect}$ 
* Fortunately, R has a command that will do it for us
* Add the predicted values to the happyWorldSmall data frame with this code:
```{r echo = TRUE}
