...
(3) Use appropriate numbers and graphs to describe the relationship between age (age) and years smoking (yearssmoking). Interpret your results.
...
(4) Take a subset of the data to delete the values of age that do not make sense and revise your graph and numbers from question 6. Explain what changed in your graph and numbers. Hint: to remove values of age that do not make sense, use age < 100 or something similar in the subset command
