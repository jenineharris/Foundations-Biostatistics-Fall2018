...
If we selected 40 M&Ms, and we knew that the likelihood of orange was 20% or .2 for each selection, the binomial distribution function can tell us how likely it is we will choose exactly 10 orange M&Ms. The 10 is represented by x in the formulas:
...
How close could we get to this number if we only had enough time and money to collect data on 25 state health departments?

```{r}
# sample 25 health departments at random 
