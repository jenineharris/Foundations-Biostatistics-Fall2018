...
(1) Use `tableone` to create a basic table that includes the appropriate descriptive statistics for following variables from the Drug Use questionnaire: DUQ200, DUQ210, DUQ250, DUQ260. 
