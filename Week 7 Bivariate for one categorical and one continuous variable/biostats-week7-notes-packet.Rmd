...
_Homogeneity of variance_ is checked using the Levene Test. The Levene Test tests the null hypothesis that the variances are equal. To meet this assumption we DO NOT want to reject the null hypothesis. Since this is about equal variance across groups, it is not relevant for the one-sample t-test because that test has only one group. 
